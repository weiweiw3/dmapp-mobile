...
!function (a) {
    ...
    !function (a, b) {
        ...
        var j, k;
        if ("undefined" == typeof window)k = require("firebase"); else if (k = window.Firebase, !k)throw new Error("Must include Firebase (http://cdn.firebase.com/v0/firebase.js) before firebase-util.js");
        b.pkg = function (a) {
            return b[a] || (b[a] = {}), b[a]
        };
        var l = b.pkg("util");
        l.Firebase = k, l.isDefined = function (a) {
        ...
        }, l.isFunction = function (a, b) {
            return"string" == typeof b ? l.isObject(a) && l.has(a, b) && "function" == typeof a[b] : "function" == typeof a
            ...
            var a = l.toArray(arguments), b = a[0] === !0 && a.shift(), c = a.shift();
            ...
            if (h(a) && (a = Array.prototype.slice.call(a, 0)), l.isArray(a)) {
                for (var d = 0, e = a.length; e > d; d++)if (b.call(c, a[d], d, a) === !0)return a[d]
            } else if (l.isObject(a)) {
                var f;
                for (f in a)if (a.hasOwnProperty(f) && b.call(c, a[f], f, a) === !0)return a[f]
            }
            return j
        }, l.filter = function (a, b, c) {
            var d = l.isArray(a), e = d ? [] : {};
            return l.each(a, function (f, g) {
                b.call(c, f, g, a) && (d ? e.push(f) : e[g] = f)
            }), e
        }, l.has = function (a, b) {
            return l.isArray(a) && a[b] !== j || l.isObject(a) && a[b] !== j || !1
        }, l.val = function (a, b) {
            ...
            if (h(a) && (a = Array.prototype.slice.call(a, 0)), l.isArray(a))(a.forEach || e).call(a, b, c); else if (l.isObject(a)) {
                var d;
            ...
            if (l.isObject(a) && l.isObject(b)) {
                var d = l.isArray(a), e = l.isArray(b);
                if (d || e)return d && e && a.length === b.length && !l.contains(a, function (a, c) {
                    return!l.isEqual(a, b[c])
                });
                var f = c ? l.keys(a) : l.keys(a).sort(), g = c ? l.keys(b) : l.keys(b).sort();
            ...
            var a = l.toArray(arguments), d = a.shift(), e = d.match(/(%s|%d|%j)/g);
        ...
        }, l.isFirebaseRef = function (a) {
            return a instanceof l.Firebase || l.isFunction(a, "ref") && a.ref()instanceof l.Firebase
        }, i.prototype = new Error, a.NotSupportedError = l.NotSupportedError = i, a._ForTestingOnly = b
    }(a, b), function (a, b) {
        function c() {
            var a;
        ...
        function e(a) {
            var c = a.slice(0), d = c.shift(), e = d.match(/(%s|%d|%j)/g);
        ...
        var i = 2, j = !1, k = {error: d, warn: d, info: d, log: d, debug: d, time: d, timeEnd: d, group: d, groupEnd: d}, l = function () {
        ...
        function c(a, b) {
            b || (b = {}), this._observableProps = h.extend({onAdd: h.noop, onRemove: h.noop, onEvent: h.noop, oneTimeEvents: []}, b, {eventsMonitored: a, observers: {}, oneTimeResults: {}}), this.resetObservers()
        }
        ...
        var g = b.pkg("log"), h = b.pkg("util");
        c.prototype = {observe: function (a, b, c, d) {
            ...
            var b = h.Args("triggerEvent", arguments), c = b.listFromWarn(this._observableProps.eventsMonitored, !0), d = b.restAsList();
        ...
        function c(a, b, c, d, e, f) {
            ...
            this.observable = a, this.fn = c, this.event = b, this.cancelFn = e || function () {
            }, this.context = d, this.oneTimeEvent = !!f
        }
        ...
        var h, i = b.pkg("util"), j = b.pkg("log");
        c.prototype = {orig: function () {
        ...
        var m, n = b.pkg("util"), o = b.pkg("log"), p = b.pkg("join"), q = ["child_added", "child_removed", "child_changed", "child_moved", "value"];
        c.prototype = {auth: function (a, b, c) {
            ...
            b = c.next("function", n.noop), this.queue.done(function () {
                if (g(this.paths, b) && h(this.paths, a, b)) {
                    var c = i(a, k(this.paths) ? this.paths[0] : null), d = j(a);
            ...
            return a = n.isObject(a) ? n.extend({}, a) : {".value": a}, a[".priority"] = b, this.set(a, c)
            ...
            b = n.Args("set", Array.prototype.slice.call(arguments), 1, 2).skip().next("function", n.noop), this.queue.done(function () {
                if (g(this.paths, b) && h(this.paths, a, b)) {
                    var c = i(a, k(this.paths) ? this.paths[0] : null), d = n.createQueue();
                    n.each(this.paths, function (a) {
            ...
            var c = b.length;
            this.queue.done(function () {
                if (c && !this.hasObservers(a))if ((this.joinedParent ? o.debug : o)("JoinedRecord(%s) Stopped observing %s events", this.name(), a ? '"' + a + '"' : ""), this.joinedParent)n.call(this.paths, "stopObserving", a, this._pathNotification, this); else if (!this.hasObservers()) {
            ...
            var d = b.name(), e = n.has(this.loadingChildRecs, d);
            ...
            var c, d = this.sortedChildKeys.length, e = null;
            if (b && 0 !== d ? (c = n.indexOf(this.sortedChildKeys, b), -1 === c ? c = d : c++) : c = 0, a.prevChildName = c > 0 ? this.sortedChildKeys[c - 1] : null, this.sortedChildKeys.splice(c, 0, a.name()), d > c) {
                var f = this.sortedChildKeys[c + 1], g = this._getJoinedChild(f);
            ...
            if (this._isValueLoaded()) {
                if ("value" === a) {
                    var d = e(this);
                    c.notify(d)
                } else if ("child_added" === a)if (this.joinedParent) {
                    var f = null;
        ...
        var c = a.pkg("log"), d = a.pkg("util"), e = a.pkg("join");
        b.prototype = {done: function (a, b) {
            ...
            d.each(a, function (a, f) {
                if (d.isObject(a)) {
                    var g = f;
                    a instanceof d.Firebase || a instanceof e.JoinedRecord ? a = {ref: a} : a.aliasedKey && (g = a.aliasedKey), a.keyMap = {".value": g}, c[f] = g, b[f] = new e.Path(a)
                } else c[f] = a === !0 ? f : a
            ...
            this.queue.addCriteria(function (b) {
                a.observeOnce("keyMapLoaded", function (c) {
                    this.keyMap = a.isJoinedChild() ? {".value": ".value"} : d.extend({}, c), b()
                }, this)
            }, this)
                    ...
                    if (d.isObject(e.val())) {
                        ...
                        e.forEach(function (b) {
                            return g.push(b.name()), d.isObject(b.val()) ? (d.each(b.val(), function (a, b) {
                                f[b] = b
                            }), !1) : d.isEmpty(b.val()) ? !1 : (f = {".value": a.ref().name()}, !0)
        ...
        "use strict";
        function b(a, b) {
            if (this._super(this, m, k.bindAll(this, {onAdd: this._observerAdded, onRemove: this._observerRemoved, oneTimeEvents: ["keyMapLoaded", "dynamicKeyLoaded"]})), this.subs = [], this.parentPath = b, this.props = c(a, b), this.dynamicChildPaths = null, !this.props.pathName)throw new Error("No pathName found; path cannot be set to Firebase root");
            this._buildKeyMap(b), this._initDynamicSource()
        }

        function c(a, b) {
            if (k.isFirebaseRef(a) || a instanceof l.JoinedRecord)a = {ref: a}; else {
                if (!a.ref)throw new Error("Must declare ref in properties hash for all Util.Join functions");
                a = k.extend({}, a)
            }
            var c = k.extend({intersects: !1, ref: null, keyMap: null, sortBy: !1, pathName: null, dynamicSource: null, dynamicKey: i, dynamicAbstracts: {}, sync: !1, callback: function () {
            }}, a);
            return k.isArray(c.keyMap) && (c.keyMap = e(c.keyMap)), c.pathName = (b && !c.dynamicSource ? d(b).replace(/\/$/, "") + "/" : "") + d(c.ref), c
        }

        function d(a) {
            return k.isFunction(a, "name") && a.name() || k.isFunction(a, "ref") && a.ref().name() || ""
        }
        ...
        function f(a) {
            return k.has(a, ".value") && (a = a[".value"]), k.isEmpty(a) && (a = null), a
        }
        ...
        function g(a, b, c, d, e) {
            ...
            if (!e && a.hasDynamicChild(c)) {
                var h = ".id:" + d;
                g = k.has(b, h) ? b[h] : null
            } else k.has(b, f) && (g = b[f]);
            return g
        }
        ...
        var i, j = a.pkg("log"), k = a.pkg("util"), l = a.pkg("join"), m = ["child_added", "child_removed", "child_moved", "child_changed", "value", "keyMapLoaded", "dynamicKeyLoaded"];
        b.prototype = {child: function (a) {
            ...
            return c === i && (j.info('Path(%s): Asked for child key "%s"; it is not in my key map', this.name(), a), c = a), ".value" === c ? this : new b(this.ref().child(c), this)
        }, dynamicChild: function (a, c) {
            return new b({ref: this.ref(!0), dynamicSource: a, keyMap: {".value": c}, sync: this.props.sync}, this)
        }, name: function () {
            ...
            k.defer(function () {
                this.isReadyForOps() ? this.ref(!0).once("value", function (c) {
                    this.isJoinedChild() ? this._parseRecord(c, a, b) : this._parseRecordSet(c, a, b)
                }, this) : (j.debug("Path(%s) loadData() called but dynamic key has not loaded yet; waiting for dynamicKeyLoaded event", this.name()), this._waitForReady(a, b))
            }, this)
        }, pickAndSet: function (a, b, c) {
            if (this.isDynamic())j.debug("Path(%s) is dynamic (ready only), so pickAndSet was ignored", this.name()), b(null); else if (null === a)this.ref().remove(b); else {
                var d = this._dataForSetOp(a);
                this.isSortBy() && c !== i ? this.ref().setWithPriority(d, c, b) : this.ref().set(d, b)
            }
        }, pickAndUpdate: function (a, b) {
            if (!k.isObject(a))throw new Error("Update failed: First argument must be an object containing the children to replace.");
            if (this.isDynamic())j.debug("Path(%s) is dynamic (ready only), so pickAndUpdate was ignored", this.name()), b(null); else {
                var c = this._dataForSetOp(a, !0);
                k.isEmpty(c) ? b(null) : this.isPrimitive() ? this.ref().set(c, b) : this.ref().update(c, b)
            }
        }, remove: function (a) {
            this.ref().remove(a)
            ...
            var b = null;
            return this.isDynamic() ? this.isReadyForOps() && (b = this.props.ref.child(this.props.dynamicKey)) : b = this.props.ref, b && !a ? b.ref() : b
        }, hasKey: function (a) {
            return k.contains(this.getKeyMap(), a)
        }, sourceKey: function (a) {
            var b = a;
            return this.isJoinedChild() && k.find(this.props.keyMap, function (c, d) {
                var e = c === a;
                return e && (b = d), e
            }), b
            ...
            return k.has(this.getKeyMap(), ".value") && this.isJoinedChild()
        }, removeConflictingKey: function (a, b) {
            j("Path(%s) cannot use key %s->%s; that destination field is owned by Path(%s). You could specify a keyMap and map them to different destinations if you want both values in the joined data.", this, a, this.getKeyMap()[a], b), delete this.props.keyMap[a]
            ...
            var c;
            return c = this.isJoinedChild() ? this._pickMyData(a, b) : k.mapObject(a, function (a) {
                return this._pickMyData(a, b)
            }, this)
        }, _pickMyData: function (a, b) {
            var c = {};
            return this.eachKey(a, function (d, e, f, g) {
                (!b || g && k.has(a, g) || !g && k.has(a, e)) && (c[d] = f)
            }), k.isEmpty(c) ? null : k.has(c, ".value") ? c[".value"] : c
        }, _observerAdded: function (a) {
            this.isOneTimeEvent(a) || (j('Path(%s) Added "%s" observer, %d total', a, this.name(), this.getObservers(a).length), this.subs[a] || (this._startObserving(a), this.isDynamic() && 1 === this.getObservers(k.keys(this.subs)).length && this._watchDynamicSource()))
        }, _observerRemoved: function (a, b) {
            this.isOneTimeEvent(a) || (b.length && j('Path(%s) Removed %d observers of "%s", %d remaining', a, b.length, this.name(), this.getObservers(a).length), !this.hasObservers(a) && this.subs[a] && (this._stopObserving(a), delete this.subs[a], this.isDynamic() && !this.hasObservers(k.keys(this.subs)) && this._unwatchDynamicSource()))
        }, _sendEvent: function (a, b, c) {
            function d(d) {
                (null !== d || k.contains(["child_removed", "value"], a)) && (j.debug("Path(%s)::sendEvent(%s, %s) to %d observers", this.name(), a, b.name() + (c !== i ? "->" + c : ""), this.getObservers(a).length, d), this.triggerEvent(a, this, a, b.name(), d, c, b.getPriority()))
            }
            ...
            return!this.isDynamic() || !k.isEmpty(this.props.dynamicKey)
        }, hasDynamicChild: function (a) {
            return k.has(this.dynamicChildPaths, a)
        }, isReadOnly: function () {
            return this.props.readOnly
        }, _buildKeyMap: function (a) {
            a && !a.isJoinedChild() && (this.props.intersects = a.isIntersection()), l.getKeyMapLoader(this, a).done(function (a, b, c) {
                k.isEmpty(b) && j.warn("Path(%s) contains an empty keyMap", this.name()), a && j.info('Path(%s) no keyMap specified and could not find data at path "%s", this data is now read-only!', this.name(), this.toString()), this.props.readOnly = a, this.props.keyMap = b, this.dynamicChildPaths = c, this.observeOnce("dynamicKeyLoaded", function () {
                    j.debug("Path(%s) finished keyMap: %j", this.toString(), this.getKeyMap()), this.triggerEvent("keyMapLoaded", b)
                }, this)
            }, this)
        }, _parseRecordSet: function (a, b, c) {
            var d = {}, e = this, f = k.createQueue();
            a.forEach(function (a) {
                ...
                k.isEmpty(d) && (d = null), j.debug("Path(%s) _parseRecordSet: %j", e.name(), d), b.call(c, d, a)
            })
        }, _parseRecord: function (a, b, c) {
            var d = null, e = k.createQueue(), g = a.val();
            return null !== g && (this.isPrimitive() ? d = g : (d = {}, this.eachSourceKey(g, k.bind(this._parseValue, this, e, d, a)))), e.done(function () {
                d = f(d), b.call(c, d, a)
            }, this), b
            ...
            var e = a.ref().child(b), f = this.dynamicChildPaths[b].dynamicChild(e, c);
            f.loadData(d)
        }, _iterateKeys: function (a, b, c, d) {
            var e = k.Args("_iterateKeys", Array.prototype.slice.call(arguments), 2, 4).skip();
            b = e.nextReq("function"), c = e.next("object"), d = e.next("boolean");
            var f = this.getKeyMap();
            d && f[".value"] ? b.call(c, ".value", f[".value"], a) : (k.each(f, function (e, f) {
                var h = g(this, a, f, e, d);
                b.call(c, f, e, h)
            }, this), d || k.each(this.props.dynamicAbstracts, function (d, e) {
                var f = ".id:" + d;
                b.call(c, e, d, k.has(a, f) ? a[f] : null, f)
            }))
            ...
            } else this.triggerEvent("dynamicKeyLoaded", i)
            ...
            if (a !== this.props.dynamicKey) {
                var b = this.props.dynamicKey, c = b === i, d = k.keys(this.subs);
                k.each(d, this._stopObserving, this), c || j("Path(%s) stopped observing dynamic key %s", this.name(), b), this.props.dynamicKey = a, null !== a && (h(a), j("Path(%s) observing dynamic key %s", this.name(), a), c && this.triggerEvent("dynamicKeyLoaded", a), k.each(d, this._startObserving, this))
            }
        }, _waitForReady: function (a, b) {
            this.observeOnce("dynamicKeyLoaded", function () {
                j.debug("Path(%s) loadData() dynamic key loaded, completing data load", this.name()), this.isReadyForOps() ? this.loadData(a, b) : (j("Path(%s) has a dynamic key but the key was null. Returning null for value"), a.call(b, null))
            }, this)
        }, _stopObserving: function (a) {
            this.ref(!0).off(a, this.subs[a], this)
        }, _startObserving: function (a) {
            this.subs[a] = k.bind(this._sendEvent, this, a), this.ref(!0).on(a, this.subs[a], this.abortObservers, this)
        }}, k.inherit(b, k.Observable), l.Path = b
    }(b), function (a, b) {
        "use strict";
        function c(a) {
            var b;
        ...
        function l(a) {
            return n.isFirebaseRef(a) || a instanceof o.JoinedRecord || a instanceof o.Path
        }
        ...
        var n = b.pkg("util"), o = b.pkg("join"), p = b.pkg("log");
        c.prototype = {_assertValidPaths: function (a) {
            ...
            return n.createQueue().addCriteria(function (b) {
                this.joinedParent.queue.done(function () {
                    ...
                    c.isDynamic() ? this.finalPaths.push(new o.Path({ref: c.ref(!0) || c.props.ref.push(), keyMap: {".value": ".value"}}, c)) : this.finalPaths.push(c.child(a)), b()
                }, this).fail(b)
            }, this)
        }, _loadRecord: function (a) {
            var b = n.createQueue(), c = this.finalPaths, d = this.joinedParent;
        ...
        function g(a, b) {
            var c = {intersects: [], unions: [], both: [], expect: 0, sortIndex: 0};
        ...
        var j = b.pkg("util"), k = b.pkg("log"), l = b.pkg("join");
        ...
        function c(a, b) {
            ...
            var c = d.map(a, function (a, c) {
                ...
                return(d.isFirebaseRef(a) || a instanceof e.JoinedRecord) && (a = {ref: a}), b(a)
            });
            return d.construct(e.JoinedRecord, c)
        }

        var d = b.pkg("util"), e = b.pkg("join");
        a.join = function () {
